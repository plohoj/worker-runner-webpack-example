...
/***/ "./node_modules/@worker-runner/core/esm/core.mjs":
/*!*******************************************************!*\
  !*** ./node_modules/@worker-runner/core/esm/core.mjs ***!
  \*******************************************************/
...
/* harmony import */ var _worker_runner_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @worker-runner/core */ "./node_modules/@worker-runner/core/umd/core.umd.js");
/* harmony import */ var _worker_runner_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_worker_runner_core__WEBPACK_IMPORTED_MODULE_0__);
...
/***/ "./node_modules/@worker-runner/core/umd/core.umd.js":
/*!**********************************************************!*\
  !*** ./node_modules/@worker-runner/core/umd/core.umd.js ***!
  \**********************************************************/
...
(function (global, factory) {
     true ? factory(exports, __webpack_require__(/*! @worker-runner/core */ "./node_modules/@worker-runner/core/esm/core.mjs")) :
    undefined;
    ...
    (function (NodeResolverAction) {
        NodeResolverAction[NodeResolverAction["INIT_RUNNER"] = 0] = "INIT_RUNNER";
        NodeResolverAction[NodeResolverAction["DESTROY"] = 1] = "DESTROY";
    })(exports.NodeResolverAction || (exports.NodeResolverAction = {}));
    ...
    (function (RunnerControllerAction) {
        ...
        RunnerControllerAction[RunnerControllerAction["DESTROY"] = 12] = "DESTROY";
        RunnerControllerAction[RunnerControllerAction["RESOLVE"] = 13] = "RESOLVE";
    })(exports.RunnerControllerAction || (exports.RunnerControllerAction = {}));
    ...
    (function (RunnerEnvironmentAction) {
        ...
        RunnerEnvironmentAction[RunnerEnvironmentAction["DESTROY_ERROR"] = 15] = "DESTROY_ERROR";
        RunnerEnvironmentAction[RunnerEnvironmentAction["RESOLVED"] = 16] = "RESOLVED";
    })(exports.RunnerEnvironmentAction || (exports.RunnerEnvironmentAction = {}));
    ...
    (function (WorkerResolverAction) {
        ...
        WorkerResolverAction[WorkerResolverAction["RUNNER_INIT_ERROR"] = 2] = "RUNNER_INIT_ERROR";
        WorkerResolverAction[WorkerResolverAction["DESTROYED"] = 3] = "DESTROYED";
    })(exports.WorkerResolverAction || (exports.WorkerResolverAction = {}));
    ...
    (function (WorkerRunnerErrorCode) {
        ...
        WorkerRunnerErrorCode[WorkerRunnerErrorCode["WORKER_NOT_INIT"] = 4] = "WORKER_NOT_INIT";
        WorkerRunnerErrorCode[WorkerRunnerErrorCode["UNEXPECTED_ERROR"] = 5] = "UNEXPECTED_ERROR";
    })(exports.WorkerRunnerErrorCode || (exports.WorkerRunnerErrorCode = {}));
    ...
    class WorkerRunnerUnexpectedError extends WorkerRunnerError {
        constructor(config = {}) {
            ...
            this[_a] = exports.WorkerRunnerErrorCode.UNEXPECTED_ERROR;
        }
    }
    _a = WORKER_RUNNER_ERROR_CODE;
    ...
    class RunnerInitError extends WorkerRunnerError {
        constructor(config = {}) {
            ...
            this[_a$1] = exports.WorkerRunnerErrorCode.RUNNER_INIT_ERROR;
        }
    }
    _a$1 = WORKER_RUNNER_ERROR_CODE;
    class RunnerWasDisconnectedError extends WorkerRunnerError {
        constructor(config = {}) {
            ...
            this[_b] = exports.WorkerRunnerErrorCode.RUNNER_NOT_INIT;
        }
    }
    _b = WORKER_RUNNER_ERROR_CODE;
    class RunnerExecuteError extends WorkerRunnerError {
        constructor(config = {}) {
            ...
            this[_c] = exports.WorkerRunnerErrorCode.RUNNER_EXECUTE_ERROR;
        }
    }
    _c = WORKER_RUNNER_ERROR_CODE;
    class RunnerDestroyError extends WorkerRunnerError {
        constructor(config = {}) {
            ...
            this[_d] = exports.WorkerRunnerErrorCode.RUNNER_DESTROY_ERROR;
        }
    }
    _d = WORKER_RUNNER_ERROR_CODE;
    class WorkerNotInitError extends WorkerRunnerError {
        constructor(config = {}) {
            ...
            this[_e] = exports.WorkerRunnerErrorCode.RUNNER_NOT_INIT;
        }
    }
    _e = WORKER_RUNNER_ERROR_CODE;

    const CODE_TO_ERROR_MAP = {
        [exports.WorkerRunnerErrorCode.RUNNER_INIT_ERROR]: RunnerInitError,
        [exports.WorkerRunnerErrorCode.RUNNER_EXECUTE_ERROR]: RunnerExecuteError,
        [exports.WorkerRunnerErrorCode.RUNNER_DESTROY_ERROR]: RunnerDestroyError,
        [exports.WorkerRunnerErrorCode.RUNNER_NOT_INIT]: RunnerWasDisconnectedError,
        [exports.WorkerRunnerErrorCode.WORKER_NOT_INIT]: WorkerNotInitError,
        [exports.WorkerRunnerErrorCode.UNEXPECTED_ERROR]: WorkerRunnerUnexpectedError,
    };
        ...
        serialize(error = {}, alternativeError = {}) {
            if (error instanceof Error) {
                ...
                if (typeof errorCode !== 'number') {
                    errorCode = alternativeError.errorCode;
                    if (typeof errorCode !== 'number') {
                        errorCode = exports.WorkerRunnerErrorCode.UNEXPECTED_ERROR;
                    }
                }
                return {
                    errorCode,
            ...
            return {
                errorCode: typeof alternativeError.errorCode === 'number' ?
                    alternativeError.errorCode : exports.WorkerRunnerErrorCode.UNEXPECTED_ERROR,
                name: alternativeError.name || WorkerRunnerUnexpectedError.name,
                message: error ? String(error) : (alternativeError.message
                    || WORKER_RUNNER_ERROR_MESSAGES.UNEXPECTED_ERROR()),
                stack: alternativeError.stack,
    ...
    ***************************************************************************** */
    ...
    class RunnerController {
        ...
        execute(methodName, args) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                this.sendAction({
                    type: exports.RunnerControllerAction.EXECUTE,
                    id: actionId,
                    args: serializedArgumentsData.args,
                    method: methodName,
                }, serializedArgumentsData.transfer);
                const actionResult = yield executePromise$;
                if (actionResult.type === exports.RunnerEnvironmentAction.EXECUTED_WITH_RUNNER_RESULT) {
                    return this.buildControlClone(actionResult.runnerId, actionResult.port).resolvedRunner;
                }
                return actionResult.response;
            });
        ...
        disconnect() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const disconnectPromise$ = this.promises.promise(actionId);
                this.sendAction({
                    type: exports.RunnerControllerAction.DISCONNECT,
                    id: actionId,
                });
                yield disconnectPromise$;
                this.onDisconnect();
        ...
        destroy() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const destroyPromise$ = this.promises.promise(actionId);
                this.sendAction({
                    type: exports.RunnerControllerAction.DESTROY,
                    id: actionId,
                });
                yield destroyPromise$;
            });
        ...
        resolveControl() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const promise$ = this.promises.promise(actionId);
                this.sendAction({
                    type: exports.RunnerControllerAction.RESOLVE,
                    id: actionId,
                });
                return (yield promise$).port;
            });
        ...
        handleAction(action) {
            switch (action.type) {
                case exports.RunnerEnvironmentAction.DISCONNECTED:
                case exports.RunnerEnvironmentAction.EXECUTED:
                case exports.RunnerEnvironmentAction.EXECUTED_WITH_RUNNER_RESULT:
                case exports.RunnerEnvironmentAction.RESOLVED:
                    this.promises.resolve(action.id, action);
                    break;
                case exports.RunnerEnvironmentAction.DESTROYED:
                    const resolvedPromise = this.promises.forget(action.id);
                    this.onDisconnect();
                    resolvedPromise === null || resolvedPromise === void 0 ? void 0 : resolvedPromise.resolve(action);
                    break;
                case exports.RunnerEnvironmentAction.EXECUTE_ERROR:
                    this.promises.reject(action.id, this.errorSerializer.deserialize(action));
                    break;
                case exports.RunnerEnvironmentAction.DESTROY_ERROR:
                    const rejectedPromise = this.promises.forget(action.id);
                    this.onDisconnect();
                    rejectedPromise === null || rejectedPromise === void 0 ? void 0 : rejectedPromise.reject(this.errorSerializer.deserialize(action));
                    break;
        ...
        sendAction(action, transfer) {
            if (!this.port) {
                if (action.type === exports.RunnerControllerAction.EXECUTE) {
                    throw new RunnerExecuteError({
                        message: WORKER_RUNNER_ERROR_MESSAGES.RUNNER_WAS_DISCONNECTED({ runnerName: this.runnerName }),
                    });
                }
    ...
    class NodeRunnerResolverBase {
        ...
        sendInitAction(runnerId, args) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const serializedArgs = yield NodeRunnerResolverBase.serializeArguments(args);
                    this.sendAction({
                        type: exports.NodeResolverAction.INIT_RUNNER,
                        id: actionId,
                        runnerId,
                        args: serializedArgs.args,
                    }, serializedArgs.transfer);
        ...
        handleWorkerAction(action) {
            switch (action.type) {
                case exports.WorkerResolverAction.RUNNER_INITED:
                    this.initPromises.resolve(action.id, action);
                    break;
                case exports.WorkerResolverAction.RUNNER_INIT_ERROR:
                    this.initPromises.reject(action.id, this.errorSerializer.deserialize(action));
                    break;
                case exports.WorkerResolverAction.DESTROYED:
                    if (!this.destroyPromise) {
                        throw new WorkerRunnerUnexpectedError({
                            message: WORKER_RUNNER_ERROR_MESSAGES.WORKER_DESTROYED_WITHOUT_CALL(),
                        });
        ...
        initWorker() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield new Promise(resolve => {
                    worker.onmessage = (message) => {
                        if (message.data && message.data.type === exports.WorkerResolverAction.WORKER_INITED) {
                            resolve();
                        }
                    };
                });
        ...
        destroy(force = false) {
            return __awaiter(this, void 0, void 0, function* () {
                if (this.worker) {
                    ...
                    this.sendAction({
                        type: exports.NodeResolverAction.DESTROY,
                        force,
                    });
                    yield destroyPromise$;
                    this.destroyRunnerControllers();
            ...
            return __awaiter(this, void 0, void 0, function* () {
                if (this.WorkerResolverConstructor) {
                    if (this.localWorkerRunnerResolver) {
                        ...
                        this.sendAction({ type: core.NodeResolverAction.DESTROY, force });
                        yield destroyPromise$;
                        this.destroyRunnerControllers();
                        this.localWorkerRunnerResolver.sendAction = undefined;
                        if (this.localMessageChanel) {
    ...
    class RunnerEnvironment {
        ...
        handleAction(port, action) {
            return __awaiter(this, void 0, void 0, function* () {
                switch (action.type) {
                    case exports.RunnerControllerAction.EXECUTE:
                        try {
                            yield this.execute(port, action);
                        }
                        catch (error) {
                            this.sendAction(port, Object.assign({ id: action.id, type: exports.RunnerEnvironmentAction.EXECUTE_ERROR }, this.errorSerializer.serialize(error, {
                                errorCode: exports.WorkerRunnerErrorCode.RUNNER_EXECUTE_ERROR,
                                name: RunnerExecuteError.name,
                                message: WORKER_RUNNER_ERROR_MESSAGES.UNEXPECTED_ERROR({ runnerName: this.runnerName }),
                                stack: (error === null || error === void 0 ? void 0 : error.stack) || new Error().stack,
                            })));
                        ...
                        break;
                    case exports.RunnerControllerAction.DESTROY:
                        try {
                            yield this.destroy(port, action);
                        }
                        catch (error) {
                            this.sendAction(port, Object.assign({ id: action.id, type: exports.RunnerEnvironmentAction.DESTROY_ERROR }, this.errorSerializer.serialize(error, {
                                errorCode: exports.WorkerRunnerErrorCode.RUNNER_DESTROY_ERROR,
                                name: RunnerDestroyError.name,
                                message: WORKER_RUNNER_ERROR_MESSAGES.UNEXPECTED_ERROR({ runnerName: this.runnerName }),
                                stack: (error === null || error === void 0 ? void 0 : error.stack) || new Error().stack,
                            })));
                        ...
                        break;
                    case exports.RunnerControllerAction.RESOLVE:
                        yield this.resolve(port, action);
                        break;
                    case exports.RunnerControllerAction.DISCONNECT:
                        yield this.disconnect(port, action);
                        break;
                }
            });
        ...
        disconnect(port, action) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                this.sendAction(port, {
                    type: exports.RunnerEnvironmentAction.DISCONNECTED,
                    id: action.id,
                });
                port.onmessage = null;
                port.close();
        ...
        handleExecuteResponse(port, action, responseWithTransferData, transferable = []) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (RunnerBridge.isRunnerBridge(response)) {
                    ...
                    const transferPort = yield runnerController.resolveOrTransferControl();
                    this.sendAction(port, {
                        type: exports.RunnerEnvironmentAction.EXECUTED_WITH_RUNNER_RESULT,
                        id: action.id,
                        port: transferPort,
                        runnerId: runnerController.runnerId,
                    }, [transferPort, ...transferable]);
                    ...
                    this.sendAction(port, {
                        type: exports.RunnerEnvironmentAction.EXECUTED,
                        id: action.id,
                        response: response,
                    }, transferable);
                }
        ...
        notifyControllersAboutDestruction() {
            for (const port of this.ports) {
                this.sendAction(port, {
                    type: exports.RunnerEnvironmentAction.DESTROYED,
                    id: -1,
                });
                port.onmessage = null;
                port.close();
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.runnerInstance.destroy) {
                    ...
                    try {
                        ...
                        if (action && port) {
                            destroyError = Object.assign({ id: action.id, type: exports.RunnerEnvironmentAction.DESTROY_ERROR }, this.errorSerializer.serialize(error, {
                                errorCode: exports.WorkerRunnerErrorCode.RUNNER_DESTROY_ERROR,
                                message: WORKER_RUNNER_ERROR_MESSAGES.EXECUTE_ERROR({
                                    runnerName: this.runnerName,
                                    methodName: 'destroy',
        ...
        resolve(port, action) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                this.ports.push(messageChanel.port1);
                this.sendAction(port, {
                    type: exports.RunnerEnvironmentAction.RESOLVED,
                    id: action.id,
                    port: messageChanel.port2,
                }, [messageChanel.port2]);
            });
    ...
    class WorkerRunnerResolverBase {
        ...
        run() {
            self.addEventListener('message', this.onMessage.bind(this));
            this.sendAction({ type: exports.WorkerResolverAction.WORKER_INITED });
        }
        onMessage(message) {
            this.handleAction(message.data);
        }
        handleAction(action) {
            return __awaiter(this, void 0, void 0, function* () {
                switch (action.type) {
                    case exports.NodeResolverAction.INIT_RUNNER:
                        try {
                            yield this.initRunnerInstance(action);
                        }
                        catch (error) {
                            this.sendAction(Object.assign({ id: action.id, type: exports.WorkerResolverAction.RUNNER_INIT_ERROR }, this.errorSerializer.serialize(error, {
                                errorCode: exports.WorkerRunnerErrorCode.RUNNER_INIT_ERROR,
                                name: RunnerInitError.name,
                                message: WORKER_RUNNER_ERROR_MESSAGES.UNEXPECTED_ERROR(),
                                stack: (error === null || error === void 0 ? void 0 : error.stack) || new Error().stack,
                            })));
                        ...
                        break;
                    case exports.NodeResolverAction.DESTROY:
                        try {
                            yield this.destroyWorker(action.force);
                        }
                        catch (error) {
                            this.sendAction({ type: exports.WorkerResolverAction.DESTROYED });
                        }
                        break;
                }
            });
        ...
        initRunnerInstance(action) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (runnerConstructor) {
                    ...
                    runnerEnvironment.addConnectedControllers(deserializeArgumentsData.controllers);
                    this.sendAction({
                        type: exports.WorkerResolverAction.RUNNER_INITED,
                        id: action.id,
                        port: messageChanel.port2,
                    }, [messageChanel.port2]);
                }
    ...
    exports.CODE_TO_ERROR_MAP = CODE_TO_ERROR_MAP;
    exports.NodeAndLocalRunnerResolverBase = NodeAndLocalRunnerResolverBase;
    exports.NodeRunnerResolverBase = NodeRunnerResolverBase;
    exports.RUNNER_BRIDGE_CONTROLLER = RUNNER_BRIDGE_CONTROLLER;
    exports.RunnerBridge = RunnerBridge;
    exports.RunnerController = RunnerController;
    exports.RunnerDestroyError = RunnerDestroyError;
    exports.RunnerEnvironment = RunnerEnvironment;
    exports.RunnerExecuteError = RunnerExecuteError;
    exports.RunnerInitError = RunnerInitError;
    exports.RunnerWasDisconnectedError = RunnerWasDisconnectedError;
    exports.TransferRunnerData = TransferRunnerData;
    exports.WORKER_RUNNER_ERROR_CODE = WORKER_RUNNER_ERROR_CODE;
    exports.WORKER_RUNNER_ERROR_MESSAGES = WORKER_RUNNER_ERROR_MESSAGES;
    exports.WorkerNotInitError = WorkerNotInitError;
    exports.WorkerRunnerError = WorkerRunnerError;
    exports.WorkerRunnerErrorSerializer = WorkerRunnerErrorSerializer;
    exports.WorkerRunnerResolverBase = WorkerRunnerResolverBase;
...
/***/ "./node_modules/@worker-runner/promise/esm/promise.mjs":
/*!*************************************************************!*\
  !*** ./node_modules/@worker-runner/promise/esm/promise.mjs ***!
  \*************************************************************/
...
var promise_1 = __webpack_require__(/*! @worker-runner/promise */ "./node_modules/@worker-runner/promise/esm/promise.mjs");
